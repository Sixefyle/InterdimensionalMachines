...
public class CosmicQuarryOreFinderUpgradeItem extends Item implements QuarryUpgrade {

    private final int COST_MULTIPLIER = 3000;
    private final int FIND_CHANCE = 70;

    public CosmicQuarryOreFinderUpgradeItem() {
