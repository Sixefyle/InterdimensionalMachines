...
public class AdvancedQuarrySpeedUpgradeItem extends Item implements QuarryUpgrade {

    private final int COST_MULTIPLIER = 250;
    private final int TIME_MULTIPLIER = 45;
    private final int ENERGY_MULTIPLIER = 4;
