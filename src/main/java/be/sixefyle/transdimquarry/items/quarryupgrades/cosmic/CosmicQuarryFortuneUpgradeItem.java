...
public class CosmicQuarryFortuneUpgradeItem extends Item implements QuarryUpgrade {

    private final int COST_MULTIPLIER = 2500;
    private final int FORTUNE_POWER = 24;

    public CosmicQuarryFortuneUpgradeItem() {
