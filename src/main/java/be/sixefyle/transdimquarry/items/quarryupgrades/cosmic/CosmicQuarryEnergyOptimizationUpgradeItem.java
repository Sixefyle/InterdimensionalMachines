...
public class CosmicQuarryEnergyOptimizationUpgradeItem extends Item implements QuarryUpgrade {

    private final int BASE_ENERGY_COST_REDUCTION = 95;
    private final int TICK_ADDED = 300;

    public CosmicQuarryEnergyOptimizationUpgradeItem() {
