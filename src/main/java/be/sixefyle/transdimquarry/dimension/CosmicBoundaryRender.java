package be.sixefyle.transdimquarry.dimension;
...
public class CosmicBoundaryRender extends DimensionSpecialEffects {
    ...
    private void drawCelestialBodies(float pPartialTick, PoseStack pPoseStack, ClientLevel world, BufferBuilder bufferbuilder) {
        ...
        long dayTime = world.getDayTime() % (long) 200000;
        float sunOpacity;
        float moonOpacity;
        if (dayTime > 71400L) {
            dayTime -= 71400L;
