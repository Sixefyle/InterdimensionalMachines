...
public class AdvancedFoundryScreen extends AbstractContainerScreen<AdvancedFoundryMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(TransdimensionalMachines.MODID, "textures/gui/advanced_foundry.png");
