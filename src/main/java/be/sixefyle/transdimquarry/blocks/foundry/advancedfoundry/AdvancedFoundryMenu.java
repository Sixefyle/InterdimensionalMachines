...
public class AdvancedFoundryMenu extends AbstractContainerMenu {
    public final AdvancedFoundryBlockEntity blockEntity;
    ...
    public AdvancedFoundryMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(MenuRegister.ADVANCED_FOUNDRY.get(), id);

        blockEntity = (AdvancedFoundryBlockEntity) entity;
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, BlockRegister.ADVANCED_FOUNDRY.get());
    }
