...
public class EtherealFoundryScreen extends AbstractContainerScreen<EtherealFoundryMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(TransdimensionalMachines.MODID, "textures/gui/ethereal_foundry.png");
