...
public class CosmicFoundryScreen extends AbstractContainerScreen<CosmicFoundryMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(TransdimensionalMachines.MODID, "textures/gui/cosmic_foundry.png");
